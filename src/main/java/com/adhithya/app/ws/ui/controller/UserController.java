...
public class UserController {
	...
	/*
	 * http get request binding is done by @GetMapping
	 */
	@GetMapping
	...
	public UserRest createUser(@RequestBody UserDetailsRequestModel userDetails) {
		...
		/*
		 * userService would take care of the business logic of creating a new user. UserService is an interface
		 * . UserServiceImpl implements the interface, it has to be autowired to access the logic
		 */
